...
class BaseRepository(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    ...
    def commit(self) -> None:
        ...
        Exposed so the application service can own the transaction boundary
        (commit after a successful write) through the repository port, without
        importing the SQLAlchemy ``Session`` type into the application layer.
        """
        self.session.commit()
