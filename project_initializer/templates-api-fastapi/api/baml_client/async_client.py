...
class BamlAsyncClient:
    ...
    async def Chat(self, user_question: str,conversation_history: typing.Optional["types.ConversationHistory"] = None,
        baml_options: BamlCallOptions = {},
    ) -> types.ChatResponse:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.Chat(user_question=user_question,conversation_history=conversation_history,
    ...
    async def StreamChat(self, user_question: str,conversation_history: typing.Optional["types.ConversationHistory"] = None,
        baml_options: BamlCallOptions = {},
    ) -> types.ChatResponse:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.StreamChat(user_question=user_question,conversation_history=conversation_history,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="StreamChat", args={
                "user_question": user_question,"conversation_history": conversation_history,
            })
            return typing.cast(types.ChatResponse, __result__.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def Chat(self, user_question: str,conversation_history: typing.Optional["types.ConversationHistory"] = None,
        baml_options: BamlCallOptions = {},
    ...
    def StreamChat(self, user_question: str,conversation_history: typing.Optional["types.ConversationHistory"] = None,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ChatResponse, types.ChatResponse]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="StreamChat", args={
            "user_question": user_question,"conversation_history": conversation_history,
        })
        return baml_py.BamlStream[stream_types.ChatResponse, types.ChatResponse](
          __result__,
...
class BamlHttpRequestClient:
    ...
    async def StreamChat(self, user_question: str,conversation_history: typing.Optional["types.ConversationHistory"] = None,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="StreamChat", args={
            "user_question": user_question,"conversation_history": conversation_history,
        }, mode="request")
        return __result__
