...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async Chat(
        user_question: string,conversation_history?: types.ConversationHistory | null,
        __baml_options__?: BamlCallOptions<never>
          ...
          const __stream__ = this.stream.Chat(
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            "Chat",
            {
            "user_question": user_question,"conversation_history": conversation_history?? null
            },
            ...
            return __raw__.parsed(false) as types.ChatResponse
            } catch (error) {
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.StreamChat(
          user_question,conversation_history,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            user_question: string,conversation_history?: types.ConversationHistory | null,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.ChatResponse, types.ChatResponse>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.ChatResponse, types.ChatResponse>(
                  __raw__,
                  (a): partial_types.ChatResponse => a,
                  (a): types.ChatResponse => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for StreamChat", error);
              }
              }
              };
              }
