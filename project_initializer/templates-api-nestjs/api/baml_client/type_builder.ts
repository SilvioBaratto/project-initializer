...
export default class TypeBuilder {
    ...
    ChatResponse: ClassViewer<'ChatResponse', "answer">;
    
    ConversationHistory: ClassViewer<'ConversationHistory', "messages">;
    ...
    constructor() {
        ...
        this.ChatResponse = this.tb.classViewer("ChatResponse", [
          "answer",
        ]);
        
        this.ConversationHistory = this.tb.classViewer("ConversationHistory", [
          "messages",
        ]);
